...
class Searchstax_Search {
	...
	public function __construct() {
		if ( defined( 'SEARCHSTAX_SEARCH_VERSION' ) ) {
			$this->version = SEARCHSTAX_SEARCH_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'searchstax-search';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-searchstax-search-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-searchstax-search-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-searchstax-search-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-searchstax-search-public.php';

		$this->loader = new Searchstax_Search_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Searchstax_Search_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Searchstax_Search_Admin( $this->get_plugin_name(), $this->get_version() );
		...
		$this->loader->add_filter( 'add_option_searchstax_search_token_write', $plugin_admin, 'update_schema' );
		$this->loader->add_filter( 'update_option_searchstax_search_token_write', $plugin_admin, 'update_schema' );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Searchstax_Search_Public( $this->get_plugin_name(), $this->get_version() );
	...
	public function register_search_page() {
		...
		$args = array(
			'label' => __('SearchStax Search', 'searchstax_search'),
			'description' => __('SearchStax Page', 'searchstax_search'),
			'labels' => array(
				'name' => __('Search Result Pages', 'searchstax_search'),
